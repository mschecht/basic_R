...
The objects created in a R session are shown in the tab "Environment". These objects will not be available if we close the R session unless we save the work space (however you're always asked if you want to save the current work space upon closing R or R Studio).
